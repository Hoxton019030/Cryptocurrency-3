...
public interface CommodityDao extends JpaRepository<Commodity, Integer> {
	...
	public Commodity updateCommodityById(@Param("commodityName2") String commodityName,
			@Param("discribe2") String discribe, @Param("photo2") String photo, @Param("price2") Integer price,
			@Param("volume2") Integer volume, @Param("id2") String id);
