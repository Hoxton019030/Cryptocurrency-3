...
<!-- 這裡放title Logo -->
<link rel="icon" href="${contextRoot}/images/NavBarImg/icon.png"
	type="image/x-icon">
...
<body>
	...
	<nav class="navbar navbar-expand-lg navbar-light bg-light fixed-top">
		...
		<div class="collapse navbar-collapse" id="navbarNav">
			<ul class="navbar-nav">
				<li class="nav-item active"><a class="nav-link"
					href="${contextRoot}/aboutUs/intro">About us<span
						class="sr-only">(current)</span></a></li>
				<li class="nav-item active"><a class="nav-link"
					href="${contextRoot}/viewAllAjax">BeachTown<span
						class="sr-only">(current)</span></a></li>
				...
				<li class="nav-item active"><a class="nav-link"
					href="${contextRoot}/shellshop">Shell Shop</a></li>
				<li class="nav-item active"><a class="nav-link"
					href="${contextRoot}/shop/myshell">shop<span class="sr-only">(current)</span></a></li>
				<li id="backend" class="nav-item active"><a class="nav-link"
					href="http://localhost:8080/coinshell/administrator">Backend
						Administrator</a></li>
			</ul>
		</div>
		...
		<c:choose>
			...
			<c:otherwise>
				<div class="btn-group">
					<button type="button" class="btn btn-primary dropdown-toggle mr-2"
						data-toggle="dropdown" aria-expanded="false">
						${login.eMail}'s Settings</button>
					...
					<div class="dropdown-menu dropdown-menu-right">
						...
						<button class="dropdown-item" type="button">
							<a href="/coinshell/account/referral">Referral Program</a>
						</button>
						<button class="dropdown-item" type="button">
							<a href="/coinshell/account/set">Account Settings</a>
						</button>
						<button class="dropdown-item" type="button">
							<a href="${contextRoot}/logout">Log Out</a>
						</button>
						...
						<form method="post" action="/coinshell/signup">
							...
							<div class="form-group input-group">
								...
								<input type="email" required name="e-mail"
									class="account form-control" placeholder="E-mail" />
							</div>
							<!--Password-->
							<div class="form-group form-floating">
								...
								<div id="pmessage">
									<p>
										<i class="fa-solid fa-triangle-exclamation"></i> Password
										should contain both letter and number, with minimum length of
										8 characters.
									</p>
