					...
					<div class="modal-dialog">
						<div class="modal-content">
							...
							<div class="modal-body">
								...
								<input type="radio" name="emotion" id="happy1" class="input-hidden" />
								<label for="happy1">
									<img src="${contextRoot}/images/NavBarImg/hulaAvatar.png" alt="I'm happy1" />
								</label>

								<input type="radio" name="emotion" id="happy2" class="input-hidden" />
								<label for="happy2">
									<img src="${contextRoot}/images/NavBarImg/magnetaAvatar.png" alt="I'm happy2" />
								</label>
								
								<input type="radio" name="emotion" id="happy3" class="input-hidden" />
								<label for="happy3">
									<img src="${contextRoot}/images/NavBarImg/defaultAvatar.png" alt="I'm happy3" />
								</label>


								<p>Unlock more cool avatars with myShells. <a href="#">Go to Rewards page →</a></p>
								<button type="button" class="btn btn-info btn-block mt-1" onclick=""
