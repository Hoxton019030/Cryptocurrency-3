<%@ page language="java" contentType="text/html; charset=UTF-8"
    ...
    <%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c"%>
        ...
        <head>
            ...
            <title>Bootstrap 4.6 Login Form | 跳出視窗</title>
        </head>
    ...
    <span class="navbar-toggler-icon"></span>
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="#">BeachTown</a>
                        </li>
                        <li class="nav-item">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="#">Shell Shop</a>
                        </li>
                    </ul>
                </div>
                <!-- Button trigger modal -->
                <div>
                    <a href="#" type="button" class="btn btn-primary mr-2" data-toggle="modal" data-target="#loginModal">
                        <i class="fa-solid fa-anchor"></i> Log In</a>
                </div>
                ...
                <form class="form-inline my-1 my-lg-0">
                    <div class="input-group">
                        ...
                        <div class="input-group-append">
                            <button class="btn btn-secondary input-group-append" type="submit"><i class="fa-solid fa-magnifying-glass"></i></button>
                        </div>
                    </div>
                </form>
            </nav>
            ...
            <span aria-hidden="true">&times;</span>
                    ...
                    <i id="eye" class="far fa-eye-slash" onclick="showHidePwd();"></i>
                                    ...
                                    <!--Submit btn-->
                                    <button type="button" class="btn btn-info"><i class="fa-solid fa-anchor"></i> Log In </button>
                                </form>
                            </fieldset>
                      ...
                      <i id="eye" class="far fa-eye-slash" onclick="showHidePwd();"></i>
                                        ...
                                        <p>Password should contain both letter and number, with minimum length of 8 characters.</p>
                                    </div>
                                    <!--推薦人 Referral ID-->
                                    <div class="form-group input-group">
                                        <div class="input-group-prepend">
                                        ...
                                        <input type="text" class="referral form-control" placeholder="Referral / your friend's email">
                                    </div>
                                    <!--Checkbox-->
                                    <div class="form-group">
                                    ...
                                    <!--reCAPTCHA v2-->
                                    <div class="g-recaptcha" data-sitekey="6LfDfO8fAAAAAALEtexVflMvH0HDwc5HCLGPjrj5xxxxxxx"></div>
                                    <!--Submit btn-->
                                    <button type="button" class="btn btn-info"><i class="fa-solid fa-anchor"></i> Create an account
              </button>
                                </form>
                        ...
                        <div class="modal-footer">
                            <div class="tnc-div">By creating this account, you agree to our <a href="#privacy-policy頁面">privacy policy</a> and <a href="#cookies-policy頁面">cookie policy</a>.</div>
                        </div>
                    </div>
                </div>
            </div>
